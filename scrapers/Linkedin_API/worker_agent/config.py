"""
Worker Agent Configuration for Linkedin.
...
WORKER_TOKEN = os.getenv("WORKER_TOKEN", "dev-linkedin-token")
API_TYPE = os.getenv("API_TYPE", "linkedin")

# Local API endpoint (the actual scraper API this agent wraps)
LOCAL_API_URL = os.getenv("LOCAL_API_URL", "http://localhost:8008")
...
# Status Proxy Port
STATUS_PORT = int(os.getenv("STATUS_PORT", "9099"))
