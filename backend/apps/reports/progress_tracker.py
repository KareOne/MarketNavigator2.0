...
class ReportProgressTracker:
    ...
    REPORT_STEPS = {
        ...
        'tracxn': [
            ...
            {'key': 'growth_potential', 'name': 'Growth Analysis', 'description': 'Assessing growth opportunities', 'weight': 10},
            {'key': 'swot', 'name': 'SWOT Analysis', 'description': 'Strategic SWOT assessment', 'weight': 10},
            {'key': 'summaries', 'name': 'Executive Summaries', 'description': 'Generating category summaries', 'weight': 8},
            {'key': 'html_gen', 'name': 'Generating Report', 'description': 'Creating HTML report', 'weight': 4},
            {'key': 'save', 'name': 'Saving', 'description': 'Saving report and analysis sections', 'weight': 4},
        ],
        'social': [
